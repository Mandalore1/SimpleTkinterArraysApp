...
class ArraysView:
    ...
    def __init__(self, presenter):
        ...
        # Array 1
        self.array1_title = Label(self.arrays_frame, bg=self.arrays_frame["bg"], fg="White", text="Array 1", font="Arial 15",
                                  anchor=CENTER)
        ...
        # Array 2
        self.array2_title = Label(self.arrays_frame, bg=self.arrays_frame["bg"], fg="White", text="Array 2", font="Arial 15",
                                  anchor=CENTER)
        ...
        # Array 3
        self.array3_title = Label(self.arrays_frame, bg=self.arrays_frame["bg"], fg="White", text="Array 3", font="Arial 15",
                                  anchor=CENTER)
        ...
        # Generator button 1
        self.generator_button_1 = Button(self.generator_buttons_frame, bg="gray", fg="White", text="Generate array 1", font="Arial 15",
                                         command=lambda x=1: self.on_generator_button_pressed(x))
        self.generator_button_1.pack(fill=BOTH, expand=True, side=LEFT, padx=5)

        # Generator button 2
        self.generator_button_2 = Button(self.generator_buttons_frame, bg="gray", fg="White", text="Generate array 2", font="Arial 15",
                                         command=lambda x=2: self.on_generator_button_pressed(x))
        self.generator_button_2.pack(fill=BOTH, expand=True, side=LEFT, padx=5)

        # Generator button 3
        self.generator_button_3 = Button(self.generator_buttons_frame, bg="gray", fg="White", text="Generate array 3", font="Arial 15",
